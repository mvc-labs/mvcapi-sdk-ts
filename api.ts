...
export const TxApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Broadcast a batch of tx to metasv fullnode. The tx will be processed one by one.
...
export const TxApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async txBroadcastBatchPost(txRaw?: Array<TxRaw>, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BroadcastResult>>> {
...
export const TxApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        txBroadcastBatchPost(txRaw?: Array<TxRaw>, options?: any): AxiosPromise<Array<BroadcastResult>> {
