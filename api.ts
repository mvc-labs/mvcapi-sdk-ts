...
export const BlockApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async blockBlockIdGet(blockId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BlockHeader>> {
         ...
         * @throws {RequiredError}
         */
        async blockGet(last?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BlockHeader>>> {
...
export const BlockApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        blockBlockIdGet(blockId: string, options?: any): AxiosPromise<BlockHeader> {
         ...
         * @throws {RequiredError}
         */
        blockGet(last?: number, options?: any): AxiosPromise<Array<BlockHeader>> {
...
export const ContractApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} nftId Nft id of this auction.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet: async (codeHash: string, nftId: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'codeHash' is not null or undefined
            if (codeHash === null || codeHash === undefined) {
                throw new RequiredError('codeHash','Required parameter codeHash was null or undefined when calling contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet.');
            }
            // verify required parameter 'nftId' is not null or undefined
            if (nftId === null || nftId === undefined) {
                throw new RequiredError('nftId','Required parameter nftId was null or undefined when calling contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet.');
            }
            const localVarPath = `/contract/nft/auction/codeHash/{codeHash}/nftId/{nftId}/utxo`
         ...
         * @throws {RequiredError}
         */
        contractNftSellV2AddressAddressUtxoGet: async (address: string, codeHash?: string, genesis?: string, flag?: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'address' is not null or undefined
            if (address === null || address === undefined) {
                throw new RequiredError('address','Required parameter address was null or undefined when calling contractNftSellV2AddressAddressUtxoGet.');
            }
            const localVarPath = `/contract/nft/sellV2/address/{address}/utxo`
                .replace(`{${"address"}}`, encodeURIComponent(String(address)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        contractNftSellV2GenesisCodeHashGenesisUtxoGet: async (codeHash: string, genesis: string, tokenIndex?: number, max?: number, min?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'codeHash' is not null or undefined
            if (codeHash === null || codeHash === undefined) {
                throw new RequiredError('codeHash','Required parameter codeHash was null or undefined when calling contractNftSellV2GenesisCodeHashGenesisUtxoGet.');
            }
            // verify required parameter 'genesis' is not null or undefined
            if (genesis === null || genesis === undefined) {
                throw new RequiredError('genesis','Required parameter genesis was null or undefined when calling contractNftSellV2GenesisCodeHashGenesisUtxoGet.');
            }
            const localVarPath = `/contract/nft/sellV2/genesis/{codeHash}/{genesis}/utxo`
                .replace(`{${"codeHash"}}`, encodeURIComponent(String(codeHash)))
                .replace(`{${"genesis"}}`, encodeURIComponent(String(genesis)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
...
export const ContractApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash: string, nftId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContractNftAuctionUtxo>>> {
            const localVarAxiosArgs = await ContractApiAxiosParamCreator(configuration).contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash, nftId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async contractNftSellV2AddressAddressUtxoGet(address: string, codeHash?: string, genesis?: string, flag?: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContractNftSellV2Utxo>>> {
            const localVarAxiosArgs = await ContractApiAxiosParamCreator(configuration).contractNftSellV2AddressAddressUtxoGet(address, codeHash, genesis, flag, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
         ...
         * @throws {RequiredError}
         */
        async contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash: string, genesis: string, tokenIndex?: number, max?: number, min?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ContractNftSellV2Utxo>>> {
            const localVarAxiosArgs = await ContractApiAxiosParamCreator(configuration).contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash, genesis, tokenIndex, max, min, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: (configuration?.basePath || basePath) + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ContractApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash: string, nftId: string, options?: any): AxiosPromise<Array<ContractNftAuctionUtxo>> {
            return ContractApiFp(configuration).contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash, nftId, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get nft summary(count group by address) for specific codeHash and genesisId(result cached for 60s).
         ...
         * @throws {RequiredError}
         */
        contractNftSellV2AddressAddressUtxoGet(address: string, codeHash?: string, genesis?: string, flag?: string, options?: any): AxiosPromise<Array<ContractNftSellV2Utxo>> {
            return ContractApiFp(configuration).contractNftSellV2AddressAddressUtxoGet(address, codeHash, genesis, flag, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get all contract nft token utxos by codeHash and genesisId.
         ...
         * @throws {RequiredError}
         */
        contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash: string, genesis: string, tokenIndex?: number, max?: number, min?: number, options?: any): AxiosPromise<Array<ContractNftSellV2Utxo>> {
            return ContractApiFp(configuration).contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash, genesis, tokenIndex, max, min, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get contract unique utxos by codeHash and genesisId.
...
export class ContractApi extends BaseAPI {
     ...
     * @memberof ContractApi
     */
    public contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash: string, nftId: string, options?: any) {
        return ContractApiFp(this.configuration).contractNftAuctionCodeHashCodeHashNftIdNftIdUtxoGet(codeHash, nftId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContractApi
     */
    public contractNftSellV2AddressAddressUtxoGet(address: string, codeHash?: string, genesis?: string, flag?: string, options?: any) {
        return ContractApiFp(this.configuration).contractNftSellV2AddressAddressUtxoGet(address, codeHash, genesis, flag, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ContractApi
     */
    public contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash: string, genesis: string, tokenIndex?: number, max?: number, min?: number, options?: any) {
        return ContractApiFp(this.configuration).contractNftSellV2GenesisCodeHashGenesisUtxoGet(codeHash, genesis, tokenIndex, max, min, options).then((request) => request(this.axios, this.basePath));
    }
